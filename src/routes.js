...
function APIRoutes() {
  ...
  // util
  router.get('/picture/:email/:size', Util.getProfilePicByEmailAndSize);
  ...
  router.get('/team/user/:id', TeamCtrl.getFromUser);
...
exports.configure = function(app) {
  ...
  app.use('/admin/db', mongo_express(require('./config/mongo_express')));
